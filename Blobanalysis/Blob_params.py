...
TWindMult = 18				# time window for conditional averaging: Multiple of one timestep (!! Always an even number --> clear Nullposition!!) for time window for standard blob
...
SNR =1.00
smoothlenx = 25					# for x-smoothing: must be uneven, gives number of steps, taken into account for smoothing, smaller value for x-smoothing
smoothlen = 13					# for t-smoothing: must be uneven, gives number of steps, taken into account for smoothing
